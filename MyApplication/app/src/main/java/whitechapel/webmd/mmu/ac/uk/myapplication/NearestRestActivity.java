...
public class NearestRestActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_rest);

        StrictMode.ThreadPolicy policy =new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);

        // get lat and long from main activity
         lat = getIntent().getDoubleExtra("lat", 10);
        ...
        // apply margins to table row parameters for image
    ...
    private void callConnection(){
        ...
        try {
            URL url = new URL("http://sandbox.kriswelsh.com/hygieneapi/hygiene.php?op=nearest&lat="+lat+"&long="+longi);
                ...
                for (int i=0; i<jArray.length(); i++) {
                    ...
                    if ((jObject.get("RatingValue")).equals("-1")) {
                        tv[tcounter].setText(Html.fromHtml("<br>"+ "<b>"+(jObject.getString("BusinessName")+"</b>" +"<br>"+ jObject.getString("AddressLine1")
                                ...
                                + jObject.getString("PostCode")+"<br>" + "Exempt"+"<br>" +jObject.getString("DistanceKM")+ " Km Away")));
                        ...
                        tv[tcounter].setText(Html.fromHtml("<br>" + "<b>" + (jObject.getString("BusinessName") + "</b>" + "<br>" + jObject.getString("AddressLine1")
                                + "<br>" + jObject.getString("AddressLine2") + "<br>" + jObject.getString("AddressLine3") + "<br>"
                                + jObject.getString("PostCode") + "<br>" + "Rating Value: "+jObject.getString("RatingValue")+"<br>" +jObject.getString("DistanceKM")+ " Km Away")));
                    ...
                    switch (jArray.getJSONObject(i).getString("RatingValue")){
                        ...
                        case "0":
                            ...
                            Bitmap bitmapSize = Bitmap.createScaledBitmap(bmp, 300, 150, true);
                            iv[tcounter].setImageBitmap(bitmapSize);
                            break;
                        case "1":
                            bmp= BitmapFactory.decodeResource(getResources(), R.drawable.rating1);
                            bitmapSize = Bitmap.createScaledBitmap(bmp, 300, 150, true);
                            iv[tcounter].setImageBitmap(bitmapSize);
                            break;
                        case "2":
    ...
    /*private void backToMainBtn() {
        Button mainBtn = (Button) findViewById(R.id.backToMainBtn);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nearest_rest, menu);
        return true;
    }
    ...
    public  void showOnMapBtnOnClick(View view) {
        Intent intent = new Intent(NearestRestActivity.this, MainActivity.class);
